...
**Plan → Discuss → Implement:** For anything beyond a small, straightforward change: plan first, surface the decisions/risks/ambiguities that genuinely matter, ask where my input changes the outcome, then implement. Don't ask for the sake of it - for trivial decisions, use your judgement and keep moving.
