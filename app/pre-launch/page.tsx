        ...
        <main className="font-[var(--font-plus-jakarta-sans)] bg-white">
            ...
            <section className="max-w-7xl mx-auto px-10 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col gap-5">
                    ...
                    <Link
                        href="#construction"
                        className="inline-flex items-center gap-2 self-start text-sm font-semibold text-[#506147] hover:gap-3 transition-all duration-200"
                    >
            ...
            <section className="py-20 px-10 bg-[#F9F7F3]">
                <div className="max-w-2xl mx-auto text-center flex flex-col gap-5">
                    ...
                    <div className="w-10 h-0.5 bg-[#7A8C70] mx-auto" />
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {highlights.map(({ title, description, icon }) => (
                            ...
                            >
                                <span className="w-10 h-10 rounded-xl bg-[#F0EBE3] text-[#7A8C70] flex items-center justify-center">
                                    {icon}
                                </span>
                ...
                <div className="max-w-xl mx-auto flex flex-col items-center gap-6 text-center">
                    ...
                    <div className="w-full flex flex-col gap-2">
                        <div className="flex justify-between items-center text-sm font-semibold text-gray-700">
                            ...
                            <span className="text-[#506147]">Almost there</span>
                        </div>
                        <div className="w-full h-2.5 rounded-full bg-[#E0D4C0] overflow-hidden">
                            <div
                                className="h-full rounded-full bg-gradient-to-r from-[#7A8C70] to-[#506147]"
                                style={{ width: '65%' }}
                            />
                        </div>
                    </div>

                    <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#506147]/10 text-[#506147] text-sm font-semibold">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        4 Weeks Estimated Launch
                    </span>
                </div>
            </section>
